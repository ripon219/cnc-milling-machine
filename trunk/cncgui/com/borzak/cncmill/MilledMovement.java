 ...
 * This class represents a milling machine movement with the z-axis at -10 (not touching the surface)
 *
 */
public class MilledMovement extends MillingAction implements Executable {
	...
	/**
	 * Moves the x/y axis to the appropriate point after lifting the Z-axis to -10.
